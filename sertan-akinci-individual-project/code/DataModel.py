...
df = pd.read_csv('cleaned.csv', index_col='Unnamed: 0', nrows=80000)
print(df.head())
...
xl_train, xl_test, yl_train, yl_test = train_test_split(X_logr,Y_logr,test_size=0.2, random_state=13)
lr = LogisticRegression(solver='lbfgs')
